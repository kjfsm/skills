...
**`/prune-comments`**。書く瞬間の自制には天井があるので、書かれたものを別のパスで削る。順序の決まった6段を汚れていないコンテキストで当て、迷ったら Why を残し How を消す。**足す側は担当しない** — 書かれるべきだった Why not を探すのは `/two-axis-review` の Standards 軸である。
