...
- **[sharpen-request](./sharpen-request/SKILL.md)** — 「〜を整理したい」「〜を改善したい」のような曖昧な依頼を、範囲・止まる地点・方向と強さ・対象の名指し・1項目ずつ判定できる問い・比べるコスト・目的にしないものを持った指示に研ぐ。指示を出して止まり、作業は合意してから始める。モデルが自分から呼んだときは、研ぐ前に使うかをユーザーに聞く。
