...
# 4本の柱をここに書かないのも同じ理由ではなく、常駐3か所(検査 4. と 16.)の同期先を
...
lib="$(dirname "${BASH_SOURCE[0]}")/../skills/kjfsm-skills/engineering/prune-comments/scripts/comment-lines.sh"
pattern=$("$lib" pattern "$path") || exit 0
